...
import { StepRunner } from '@storybook/csf';
...
export declare const addStepRunner: (stepRunner: StepRunner) => void;
...
export declare class ClientApi<TFramework extends AnyFramework> {
    ...
    importFn(path: Path): Promise<import("@storybook/store").ModuleExports>;
    getStoryIndex(): {
        v: number;
        entries: Record<string, import("@storybook/store").IndexEntry>;
    };
