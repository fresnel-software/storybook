...
export declare type StandaloneDocsIndexEntry = DocsIndexEntry & {
    standalone: true;
};
/** A TemplateDocsIndexEntry represents a stories file that gets rendered in "docs" mode */
export declare type TemplateDocsIndexEntry = DocsIndexEntry & {
    standalone: false;
};
export declare type IndexEntry = StoryIndexEntry | DocsIndexEntry;
export declare type IndexEntryLegacy = [StoryId, any, Parameters, Parameters];
export declare type StorySortComparator = Comparator<IndexEntryLegacy>;
export declare type StorySortParameter = StorySortComparator | StorySortObjectParameter;
export declare type StorySortComparatorV7 = Comparator<IndexEntry>;
...
export declare type StoryContext<TFramework extends AnyFramework = AnyFramework> = StoryContextForFramework<TFramework>;
